...
class QuizBrain {
  ...
  void nextQuestion() async {
    dynamic r = await Requests.get('127.0.0.1:8888/next/');
  }
  ...
  void reset() async {
    var r = await Requests.get('127.0.0.1:8888/reset/');
  }

  // void transferQuestion() async {
  //   Question question;
  //   for (int i = 0; i < 100; i++) {
  ...
  Future fetchCorrectAnswer() async {
    dynamic r = await Requests.get('127.0.0.1:8888/next/');
    dynamic questionBody = r.json();
  }
